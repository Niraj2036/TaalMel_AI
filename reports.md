...
This report documents the empirical benchmark evaluation of our **Autonomous AI Finance Controller & Reconciliation Engine** (TaalMel AI). The system was evaluated across **all 4 official benchmark datasets**—ranging from Level 1 (Basic) up to Level 3 (Nightmare) and the **Dataset Mixed Test** (`dataset_mixed_test`).
...
- **Data Path**: `data/dataset_level_1/`
- **Ground Truth CSV**: `data/ground_truth/dataset_level_1.csv`
...
- **Data Path**: `data/dataset_level_2/`
- **Ground Truth CSV**: `data/ground_truth/dataset_level_2.csv`
...
- **Data Path**: `data/dataset_level_3/`
- **Ground Truth CSV**: `data/ground_truth/dataset_level_3.csv`
...
- **Data Path**: `data/dataset_mixed_test/`
- **Ground Truth CSV**: `data/ground_truth/dataset_mixed_test.csv`
